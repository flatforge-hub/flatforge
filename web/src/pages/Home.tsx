...
export default function Home() {
  ...
  return (
    <div>
      {/* Hero */}
      <section className="relative overflow-hidden border-b border-zinc-800 bg-gradient-to-b from-forge-950/30 to-zinc-950">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 sm:py-24 text-center">
          <h1 className="text-4xl sm:text-5xl font-bold text-zinc-100 mb-4 tracking-tight">
            ...
            <span className="bg-gradient-to-r from-forge-400 to-violet-300 bg-clip-text text-transparent">
              Linux desktop
            </span>
          </h1>
          ...
          <div className="max-w-xl mx-auto relative">
            ...
            <input
              ...
              className="w-full pl-11 pr-4 py-3 rounded-xl bg-zinc-900 border border-zinc-700
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10">
        ...
        {filtered.length > 0 ? (
          ...
          <div className="text-center py-24 text-zinc-500">
            ...
            <p className="text-lg font-medium text-zinc-400">No apps found</p>
