export default function Copyright() {
  return (
    <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-16">
      <h1 className="text-3xl font-bold text-zinc-900 dark:text-zinc-100 mb-2">Copyright Complaints</h1>

      <section className="mb-10 mt-10">
        <h2 className="text-lg font-semibold text-zinc-800 dark:text-zinc-200 mb-3">Scope</h2>
        ...
        <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed mt-3">
          <strong className="text-zinc-700 dark:text-zinc-300">App submissions (pull requests)</strong> are hosted
      ...
      <section className="mb-10">
        <h2 className="text-lg font-semibold text-zinc-800 dark:text-zinc-200 mb-3">Reporting infringement in a distributed app</h2>
        ...
        <ol className="list-decimal list-inside space-y-2 text-zinc-600 dark:text-zinc-400">
          ...
          <li>The application ID (e.g. <code className="text-zinc-700 dark:text-zinc-300 text-sm">org.example.MyApp</code>) and, if known, the specific file or module.</li>
      ...
      <section className="mb-10">
        <h2 className="text-lg font-semibold text-zinc-800 dark:text-zinc-200 mb-3">Our response</h2>
        ...
        <ol className="list-decimal list-inside space-y-2 text-zinc-600 dark:text-zinc-400">
          <li>Acknowledge — typically within <strong className="text-zinc-700 dark:text-zinc-300">7 days</strong>.</li>
          <li>Investigate and, where substantiated, remove the application — typically within <strong className="text-zinc-700 dark:text-zinc-300">14 days</strong> of acknowledgement.</li>
      ...
      <section className="mb-10">
        <h2 className="text-lg font-semibold text-zinc-800 dark:text-zinc-200 mb-3">Repeat infringers</h2>
        <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed">
      ...
      <section className="mb-10">
        <h2 className="text-lg font-semibold text-zinc-800 dark:text-zinc-200 mb-3">Unauthorized submissions</h2>
        <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed mb-4">
        ...
        <h3 className="text-sm font-semibold text-zinc-700 dark:text-zinc-300 mb-2">Proving authorship</h3>
        ...
        <ul className="space-y-2 text-zinc-600 dark:text-zinc-400 mb-4">
          <li className="flex gap-2"><span className="text-forge-600 dark:text-forge-400">•</span><span>Push a file named <code className="text-zinc-700 dark:text-zinc-300 text-sm">flatforge-claim.txt</code> to the root of the source repository containing your GitHub username and the App ID (e.g. <code className="text-zinc-700 dark:text-zinc-300 text-sm">github=yourusername app=io.github.yourname.AppName</code>). You may remove the file once the claim is resolved.</span></li>
          <li className="flex gap-2"><span className="text-forge-600 dark:text-forge-400">•</span><span>Open a GitHub issue in the source repository from your own account stating that you did not authorise the Flatforge submission.</span></li>
        </ul>

        <h3 className="text-sm font-semibold text-zinc-700 dark:text-zinc-300 mb-2">Submitting a claim</h3>
        <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed mb-2">
          Send an email to{' '}
          <a href="mailto:evtcsuha5@mozmail.com"
             className="text-indigo-600 dark:text-indigo-400 hover:text-indigo-500 dark:hover:text-indigo-300 underline underline-offset-2">
        ...
        <ol className="list-decimal list-inside space-y-2 text-zinc-600 dark:text-zinc-400 mb-4">
          <li>Your name and GitHub username.</li>
          <li>The App ID (e.g. <code className="text-zinc-700 dark:text-zinc-300 text-sm">io.github.username.AppName</code>).</li>
          <li>Evidence of authorship (link to the <code className="text-zinc-700 dark:text-zinc-300 text-sm">flatforge-claim.txt</code> file, or the GitHub issue you opened).</li>
          <li>A statement that you did not authorise the submission.</li>
        </ol>

        <h3 className="text-sm font-semibold text-zinc-700 dark:text-zinc-300 mb-2">Our response</h3>
        <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed mb-2">
        ...
        <ol className="list-decimal list-inside space-y-2 text-zinc-600 dark:text-zinc-400">
          <li>Put the application on hold — typically within <strong className="text-zinc-700 dark:text-zinc-300">7 days</strong> — it will not be distributed while the claim is open.</li>
          <li>Contact the submitter and give them around <strong className="text-zinc-700 dark:text-zinc-300">14 days</strong> to provide counter-evidence or written authorisation from you.</li>
      ...
      <section>
        <h2 className="text-lg font-semibold text-zinc-800 dark:text-zinc-200 mb-3">Jurisdiction</h2>
        <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed">
