...
export default function Terms() {
  return (
    <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-16">
      <h1 className="text-3xl font-bold text-zinc-900 dark:text-zinc-100 mb-2">Terms of Use</h1>
      <p className="text-zinc-500 text-sm mb-10">Last updated: June 2026</p>

      <section className="mb-10">
        <h2 className="text-lg font-semibold text-zinc-800 dark:text-zinc-200 mb-3">The service</h2>
      ...
      <section className="mb-10">
        <h2 className="text-lg font-semibold text-zinc-800 dark:text-zinc-200 mb-3">No warranty</h2>
        <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed">
          The repository and all software distributed through it are provided{' '}
          <strong className="text-zinc-700 dark:text-zinc-300">"as is"</strong>, without warranty of any kind —
        ...
        <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed mt-3">
          ...
          configuration, and source availability, but <strong className="text-zinc-700 dark:text-zinc-300">cannot
      ...
      <section className="mb-10">
        <h2 className="text-lg font-semibold text-zinc-800 dark:text-zinc-200 mb-3">Limitation of liability</h2>
        <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed">
      ...
      <section className="mb-10">
        <h2 className="text-lg font-semibold text-zinc-800 dark:text-zinc-200 mb-3">Your responsibility</h2>
        <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed">
      ...
      <section className="mb-10">
        <h2 className="text-lg font-semibold text-zinc-800 dark:text-zinc-200 mb-3">Reporting issues</h2>
      ...
      <section className="mb-10">
        <h2 className="text-lg font-semibold text-zinc-800 dark:text-zinc-200 mb-3">Service termination</h2>
        <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed">
      ...
      <section>
        <h2 className="text-lg font-semibold text-zinc-800 dark:text-zinc-200 mb-3">Governing law</h2>
        <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed">
          These terms are governed by the laws of the Czech Republic and, where applicable,
          European Union law. See also the{' '}
          <Link to="/privacy" className="text-indigo-600 dark:text-indigo-400 hover:text-indigo-500 dark:hover:text-indigo-300 underline underline-offset-2">
            Privacy Notice
          </Link>.
        </p>
      </section>
