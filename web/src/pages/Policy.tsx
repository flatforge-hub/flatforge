    ...
    <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-16">
      ...
      <section className="mb-10">
        ...
        <ul className="space-y-2 text-zinc-400 mb-6">
          ...
          <Required><strong className="text-zinc-300">Correct App ID</strong> — reverse-DNS format matching a domain the developer controls (e.g. <code className="text-zinc-300 text-sm">io.github.username.AppName</code>); see App ID verification below</Required>
      ...
      <section className="mb-10">
        <h2 className="text-lg font-semibold text-zinc-200 mb-4">Quality</h2>
      ...
      <section className="mb-10">
        <h2 className="text-lg font-semibold text-zinc-200 mb-4">App ID verification</h2>
        ...
        <div className="space-y-4 text-zinc-400 leading-relaxed">
          <div>
            <h3 className="text-sm font-semibold text-zinc-300 mb-1">GitHub or GitLab namespace</h3>
            <p>
              For <code className="text-zinc-300 text-sm">io.github.USERNAME.AppName</code> or{' '}
              <code className="text-zinc-300 text-sm">io.gitlab.USERNAME.AppName</code>, the main
              source module's URL must be hosted under{' '}
              <code className="text-zinc-300 text-sm">github.com/USERNAME/</code> or{' '}
              <code className="text-zinc-300 text-sm">gitlab.com/USERNAME/</code> respectively.
              CI checks this automatically — a mismatch blocks the PR. The PR author must have
              push access to that source repository.
            </p>
          </div>
          <div>
            <h3 className="text-sm font-semibold text-zinc-300 mb-1">Custom domain</h3>
            <p>
              For <code className="text-zinc-300 text-sm">com.example.AppName</code> or any other
              domain-based ID: add a DNS TXT record at{' '}
              <code className="text-zinc-300 text-sm">_flatforge.example.com</code> with the value{' '}
              <code className="text-zinc-300 text-sm">github=USERNAME</code>, or serve a plain-text
              file at <code className="text-zinc-300 text-sm">https://example.com/.well-known/flatforge-verify</code>{' '}
              containing the single line <code className="text-zinc-300 text-sm">github=USERNAME</code>.
              A maintainer verifies this before merging — state the verification method in your PR.
            </p>
          </div>
          <div>
            <h3 className="text-sm font-semibold text-zinc-300 mb-1">Other namespaces</h3>
            <p>
              App IDs outside the above patterns (e.g. <code className="text-zinc-300 text-sm">org.gnome.*</code>,{' '}
              <code className="text-zinc-300 text-sm">org.kde.*</code>,{' '}
              <code className="text-zinc-300 text-sm">org.freedesktop.*</code>) require explicit
              written approval from a Flatforge maintainer before submission.
            </p>
          </div>
          <div>
            <h3 className="text-sm font-semibold text-zinc-300 mb-1">Namespace squatting</h3>
            <p>
      ...
      <section className="mb-10">
        <h2 className="text-lg font-semibold text-zinc-200 mb-3">Data collection disclosure</h2>
        <p className="text-zinc-400 leading-relaxed">
          If an application requests <code className="text-zinc-300 text-sm">--share=network</code>{' '}
          and transmits user data — telemetry, crash reports, analytics, account sync, ads, etc. —
          this must be disclosed in the <code className="text-zinc-300 text-sm">data_collection</code>{' '}
          field of <code className="text-zinc-300 text-sm">metadata.yaml</code> and briefly in the
      ...
      <section className="mb-10">
        <h2 className="text-lg font-semibold text-zinc-200 mb-4">Editorial discretion</h2>
        <p className="text-zinc-400 leading-relaxed">
        ...
        <div className="mt-5 space-y-4 text-zinc-400 leading-relaxed">
          <div>
            <h3 className="text-sm font-semibold text-zinc-300 mb-1">Submission limits</h3>
            <ul className="space-y-2">
              <li className="flex gap-2"><span className="text-forge-400">•</span><span>Each GitHub account may have at most <strong className="text-zinc-300">2 open submission PRs</strong> at a time. A third PR will be closed automatically without review.</span></li>
              <li className="flex gap-2"><span className="text-forge-400">•</span><span>After a rejection, the same account must wait <strong className="text-zinc-300">30 days</strong> before opening a new submission PR.</span></li>
              <li className="flex gap-2"><span className="text-forge-400">•</span><span>Accounts found coordinating submissions across multiple GitHub accounts may have all associated submissions closed.</span></li>
            </ul>
          </div>
          <div>
            <h3 className="text-sm font-semibold text-zinc-300 mb-1">Review timeline</h3>
            <p>
              ...
              of back-and-forth. <strong className="text-zinc-300">Expedited review cannot be demanded.</strong>{' '}
              A PR that receives no activity from the submitter's side for 90 days will be closed as stale.
            </p>
          </div>
          <div>
            <h3 className="text-sm font-semibold text-zinc-300 mb-1">Submission freeze</h3>
            <p>
      ...
      <section className="mb-10">
        <h2 className="text-lg font-semibold text-zinc-200 mb-3">Forks</h2>
        <p className="text-zinc-400 leading-relaxed">
      ...
      <section className="mb-10">
        <h2 className="text-lg font-semibold text-zinc-200 mb-3">Abandoned applications</h2>
        <p className="text-zinc-400 leading-relaxed">
          An application is considered abandoned when its per-app repository has had no commits
          for <strong className="text-zinc-300">12 months</strong> and the maintainer has not
          responded to a maintenance-check issue within <strong className="text-zinc-300">30 days</strong>{' '}
          of it being opened. A scheduled workflow runs monthly, detects stale repositories, and
          opens these issues automatically.
        </p>
        <p className="text-zinc-400 leading-relaxed mt-3">
          An abandoned application is marked <code className="text-zinc-300 text-sm">status: unmaintained</code>{' '}
          in its <code className="text-zinc-300 text-sm">metadata.yaml</code> and shown with an
          "Unmaintained" badge on the website. If no response or remediation follows within a
          further <strong className="text-zinc-300">60 days</strong>, the application may be removed.
        </p>
        <p className="text-zinc-400 leading-relaxed mt-3">
          Maintainers may self-declare an application as unmaintained at any time by setting{' '}
          <code className="text-zinc-300 text-sm">status: unmaintained</code> via a PR. This is
          encouraged — it is more honest than silence.
        </p>
      </section>

      <section className="mb-10">
        <h2 className="text-lg font-semibold text-zinc-200 mb-3">Transferring an application</h2>
        <p className="text-zinc-400 leading-relaxed">
          If you can no longer maintain an application, open an issue in the per-app repository
          with the label <code className="text-zinc-300 text-sm">transfer-request</code>, including
        ...
        <p className="text-zinc-400 leading-relaxed mt-3">
          If no successor is available, set <code className="text-zinc-300 text-sm">status: unmaintained</code>{' '}
          in <code className="text-zinc-300 text-sm">metadata.yaml</code> or open an issue asking
      ...
      <section className="mb-10">
        ...
        <p className="text-zinc-400 text-sm">
          ...
          <a href="https://github.com/flatforge-hub/flatforge/blob/main/docs/CODE_OF_CONDUCT.md"
             ...
             className="text-indigo-400 hover:text-indigo-300 underline underline-offset-2">Code of Conduct</a>
        </p>
      </section>

      <section>
        <h2 className="text-lg font-semibold text-zinc-200 mb-3">Questions and pre-submission approval</h2>
        <p className="text-zinc-400 leading-relaxed">
          For anything not covered by this policy — including namespace-approval requests for
          other namespaces — open a GitHub issue with the <code className="text-zinc-300 text-sm">question</code>{' '}
          label in{' '}
