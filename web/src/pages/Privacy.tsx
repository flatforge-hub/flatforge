export default function Privacy() {
  return (
    <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-16">
      <h1 className="text-3xl font-bold text-zinc-900 dark:text-zinc-100 mb-2">Privacy Notice</h1>
      <p className="text-zinc-500 text-sm mb-10">Last updated: June 2026</p>

      <section className="mb-10">
        <h2 className="text-lg font-semibold text-zinc-800 dark:text-zinc-200 mb-3">What we collect</h2>
        <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed">
          The Flatforge web server records access logs containing a <strong className="text-zinc-700 dark:text-zinc-300">truncated
      ...
      <section className="mb-10">
        <h2 className="text-lg font-semibold text-zinc-800 dark:text-zinc-200 mb-3">Why we collect it</h2>
        <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed">
          Access logs are used solely for server operations: diagnosing errors, detecting abuse,
          and monitoring availability. The legal basis is <strong className="text-zinc-700 dark:text-zinc-300">legitimate
          interest</strong> (Article 6(1)(f) GDPR).
        </p>
      </section>

      <section className="mb-10">
        <h2 className="text-lg font-semibold text-zinc-800 dark:text-zinc-200 mb-3">GitHub</h2>
        <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed">
      ...
      <section className="mb-10">
        <h2 className="text-lg font-semibold text-zinc-800 dark:text-zinc-200 mb-3">Log retention</h2>
        <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed">
          Access logs are rotated and deleted after <strong className="text-zinc-700 dark:text-zinc-300">90 days</strong>.
        </p>
      </section>

      <section>
        <h2 className="text-lg font-semibold text-zinc-800 dark:text-zinc-200 mb-3">Contact</h2>
        <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed">
